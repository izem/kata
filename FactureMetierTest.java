...
import com.metier.AutresProduits;
import com.metier.FactureMetier;
import com.metier.IFactureMetier;
import com.metier.Livres;
import com.metier.MedicamentsAndAliments;
...
public class FactureMetierTest extends TestCase {
	...
	private double coutProduit(Produit produit) {
		double coutProduitTTC = facture.calculTaxeProduit(produit.getTaxe(), produit.getPrix() , produit.getQuantite(), produit.isImported());
